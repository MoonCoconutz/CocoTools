...
Any PNG (or JPG) dropped in here appears under the **Custom** tab of CocoPies's
...
Note that reinstalling CocoPies replaces its whole folder, this one included.
...
with nothing in it. CocoPies now checks each file's header and skips one whose
