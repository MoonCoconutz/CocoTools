    ...
    return [
        ...
        # needed here.
        {
            ...
            "items": [
                ...
                # Mio3 Align > Center in island mode, default Bounding Box pivot:
                # islands stack where they are rather than jumping to the UV
                # area centre (which is what Zen UV Simple Stack did).
                {"label": "Stack Islands", "icon": 'DUPLICATE', "position": 1, "enabled": True,
                 "command": "bpy.ops.uv.mio3_align(type='CENTER', island=True)"},
