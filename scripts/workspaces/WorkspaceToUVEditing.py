"""Switch the active workspace to "UV Editing".

Bundled with CocoPies as an example of a pie slot that runs a script file.
...
def main():
    ...
    if workspace is None:
        ...
        print("CocoPies: no workspace named %r in this file" % WORKSPACE)
        return
